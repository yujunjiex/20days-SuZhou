        ...
        h = b.Hex = {
            stringify: function(a) { var c = a.words;
                a = a.sigBytes; for (var b = [], d = 0; d < a; d++) { var f = c[d >>> 2] >>> 24 - 8 * (d % 4) & 255;
                    ...
                    b.push((f & 15).toString(16)) } return b.join("") },
            parse: function(a) {
        ...
        k = j.BufferedBlockAlgorithm = f.extend({
            ...
            _process: function(a) { var c = this._data,
                ...
                d = e.min(4 * a, d); if (a) { for (var g = 0; g < a; g += f) this._doProcessBlock(b, g);
                    g = b.splice(0, a);
                    c.sigBytes -= d } return new n.init(g, d) },
            clone: function() {
...
(function() {
    var e = CryptoJS,
        ...
        m = e.algo.SHA1 = j.extend({
            ...
            _doFinalize: function() { var f = this._data,
                    e = f.words,
            ...
            clone: function() { var e = j.clone.call(this);
